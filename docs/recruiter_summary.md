...
The project shows how to convert a complex political economy question into structured data, documented assumptions, repeatable scripts, and clear outputs. It is not just a written research paper; it is an end-to-end evidence workflow.

It is especially relevant for roles involving research analytics, geopolitical risk, policy analysis, data storytelling, market intelligence, or decision-support tooling.
...
- Static dashboard development with HTML, CSS, and JavaScript.
- Clear documentation for academic and non-academic audiences.
