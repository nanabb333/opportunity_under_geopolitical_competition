...
Uncertainty should remain visible. The system should preserve:

- limited sample size warnings
- qualitative coding caveats
- `TBD` and `Not coded` fields
- source and evidence-note limitations
- distinctions between candidate events and approved historical events
...
The correct use of this system is structured evidence review, not prediction or investment recommendation.
