...
- Translating an ambiguous geopolitical problem into a structured analytical workflow.
- Building scenario comparison outputs for nontechnical interpretation.
- Communicating limitations and decision boundaries clearly.
- Creating portfolio-ready evidence views and operating summaries.
- Designing a review process that distinguishes candidate information from approved evidence.
...
- Pipeline orchestration with PASS/FAIL reporting.
- Reproducible local execution without external services.
...
- operations overview in the dashboard

These components make the project more scalable while preserving human review and research transparency.

## Limitations

- The approved dataset remains limited.
